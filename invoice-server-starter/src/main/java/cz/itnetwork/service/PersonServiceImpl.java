...
public class PersonServiceImpl implements PersonService {
    ...
    public List<PersonStatistics> getStatistics() {
        List<PersonEntity> persons = personRepository.findByHidden(false);
        List<PersonStatistics> personStatistics = new ArrayList<>();

        for (PersonEntity personEntity : persons){
            BigDecimal revenue = invoiceRepository.getRevenue(personEntity.getId());
